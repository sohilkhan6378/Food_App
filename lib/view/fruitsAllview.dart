...
class Fruitsallview extends StatelessWidget {

  bool isBool = true;

  Fruitsallview({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("All FruitsProduct"),
        centerTitle: true,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: StreamBuilder(stream: FirebaseFirestore.instance.collection("FruitCollection").snapshots(), builder: (context,snapshot){
