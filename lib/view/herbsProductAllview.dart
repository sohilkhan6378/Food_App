...
class Herbsproductallview extends StatefulWidget {
  const Herbsproductallview({super.key});

  @override
  State<Herbsproductallview> createState() => _HerbsproductallviewState();
}

class _HerbsproductallviewState extends State<Herbsproductallview> {
  String query ="";
  String productName ="";
  bool isBool = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("All HerbsProduct"),
        centerTitle: true,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: StreamBuilder(stream: FirebaseFirestore.instance.collection("HerbsProductCollection").snapshots(), builder: (context,snapshot){
